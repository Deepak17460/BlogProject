...
import { addLike, getAllLikes } from '../controller/like-controller.js';
...
router.get('/post/likes/:id',authenticateToken, getAllLikes);
router.post('/post/addLike',authenticateToken,addLike);
